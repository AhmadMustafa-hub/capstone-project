...
if (isset($_POST['submit'])) {
  $x->admin_email = $_POST['email'];
  $x->admin_password=$_POST['pass'];
  $data=$x->login();
  if ($data[0]['admin_id']) {
    $_SESSION['email'] = $_POST['email'];
    $_SESSION['name'] = $data[0]['admin_fullname'];
    $_SESSION['admin_id'] = $data['0']['admin_id'];
    $_SESSION['admin_image'] = $data['0']['admin_image'];
    header("location:index.php");
  } else {
    $error = "<div class='alert alert-danger'><b>Invalid Admin !</b></div>";
  }
}
?>
<!DOCTYPE html>
